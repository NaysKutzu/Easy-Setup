#!/bin/sh
printf "Welcome to KoolCDN installer script"
...
show_menu(){
    ...
    fgred=`echo "\033[31m"`
    printf "\n${menu}*********************************************${normal}\n"
    printf "${menu}**${number} 1)${menu} Setup ssh acces via password ${normal}\n"
    printf "${menu}**${number} 2)${menu} Install the packages ${normal}\n"
    printf "${menu}**${number} 3)${menu} Something ${normal}\n"
